...
class BlockSpaceManagerV2(BlockSpaceManager):
    ...
    def can_swap_in(self, seq_group: SequenceGroup,
        ...
        if seq_group.input_is_kv_cache():
            raise NotImplementedError(
                "can_swap_in for seq_group with kv_cache input is not supported"
            )
    ...
    def swap_in(self, seq_group: SequenceGroup) -> BlocksToSwapIn:
        ...
        if seq_group.input_is_kv_cache():
            raise NotImplementedError(
                "swap_in for seq_group with kv_cache input is not supported")
        ...
        return BlocksToSwapIn(cpu_blocks=physical_block_id_mapping)
